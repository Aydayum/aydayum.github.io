...
var wasmBinaryFile;
  wasmBinaryFile = 'simple_bof_xss.wasm';
...
var ASM_CONSTS = {
  1040: ($0, $1) => { document.getElementById("xss").innerHTML =(UTF8ToString($0,$1)); }
};
...
/** @type {function(...*):?} */
var _vulnerable_function = Module["_vulnerable_function"] = createExportWrapper("vulnerable_function");
